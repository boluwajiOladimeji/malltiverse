...
function ProductDetailsSingle() {
  ...
  return (
    <div className='px-4 py-8 md:py-24'>
      <div className='max-w-6xl mx-auto space-y-12 md:grid md:grid-cols-2 md:gap-12 md:space-y-0'>
        <div className=' flex flex-col justify-between'>
          <div className='space-y-6'>
            ...
            <div className={`grid grid-cols-${photos.length} gap-2 md:mt-auto`}>
              {photos.map((photo, idx) => {
                return (
                  <div
                    className={`bg-light-gray cursor-pointer p-4 grid place-items-center rounded-md border ${
                      idx === activeImg
                        ? ' border-reddish'
                        : 'border-light-gray'
                    } `}
